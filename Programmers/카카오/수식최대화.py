...
def cal(op, num, order):
    print("----- order: ", order)
    for o in order:
        print("before: ", op, num)
        op_, num_= deque(),deque()
        while op:
            operator= op.popleft()
            if operator == o:
                num.appendleft(eval(f"{num.popleft()}{operator}{num.popleft()}"))
            else:
                op_.append(operator)
                num_.append(num.popleft())
        op = deque(op_+op)
        num = deque(num_+num)
        print("after: ", op, num)
    print("aaaaaafter: ", op, num)
    print(num)
    return abs(int(num[0]))

def solution(expression):
    answer = 0
    op = deque(re.findall("[-|+|*]", expression))
    num = deque(re.findall("[0-9]+", expression))
    for p in permutations(['-','+','*'],3):
        n = cal(copy(op), copy(num), p)
        answer = max(answer, n)
    return answer
...
테스트 2 〉	통과 (0.51ms, 10.4MB)
테스트 3 〉	통과 (0.65ms, 10.3MB)
테스트 4 〉	통과 (0.73ms, 10.4MB)
테스트 5 〉	통과 (0.54ms, 10.3MB)
테스트 6 〉	통과 (0.49ms, 10.3MB)
테스트 7 〉	통과 (0.50ms, 10.4MB)
테스트 8 〉	통과 (0.55ms, 10.4MB)
테스트 9 〉	통과 (1.00ms, 10.4MB)
테스트 10 〉	통과 (0.94ms, 10.3MB)
테스트 11 〉	통과 (1.07ms, 10.3MB)
테스트 12 〉	통과 (0.72ms, 10.4MB)
테스트 13 〉	통과 (0.84ms, 10.3MB)
테스트 14 〉	통과 (1.32ms, 10.3MB)
테스트 15 〉	통과 (0.87ms, 10.3MB)
테스트 16 〉	통과 (0.33ms, 10.4MB)
테스트 17 〉	통과 (0.34ms, 10.3MB)
테스트 18 〉	통과 (0.53ms, 10.4MB)
테스트 19 〉	통과 (0.57ms, 10.4MB)
테스트 20 〉	통과 (0.31ms, 10.3MB)
테스트 21 〉	통과 (0.89ms, 10.3MB)
테스트 22 〉	통과 (1.49ms, 10.4MB)
테스트 23 〉	통과 (0.29ms, 10.4MB)
테스트 24 〉	통과 (0.91ms, 10.3MB)
테스트 25 〉	통과 (0.87ms, 10.3MB)
테스트 26 〉	통과 (0.28ms, 10.3MB)
테스트 27 〉	통과 (0.90ms, 10.5MB)
테스트 28 〉	통과 (0.93ms, 10.3MB)
테스트 29 〉	통과 (0.83ms, 10.3MB)
테스트 30 〉	통과 (0.92ms, 10.3MB)
채점 결과
정확성: 100.0
합계: 100.0 / 100.0
'''