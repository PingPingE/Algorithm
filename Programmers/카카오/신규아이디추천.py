...
def step2(target):
    return ''.join(re.findall('[a-z]|[0-9]|[-]|[_]|[.]', target))

def step3(target):
    tmp = re.compile('[.]{2,}')
    return tmp.sub('.', target)

def step4(target):
    return target.strip('.')

def step5(target):
    return 'a' if not target else target

def step6(target):
    return target[:15].rstrip('.')

def step7(target):
    remain = 3 - len(target)
    return target if remain <= 0 else target + target[-1] * remain

def get_new_id(target):
    t1 = step1(target)
    t2 = step2(t1)
    t3 = step3(t2)
    t4 = step4(t3)
...
테스트 5 〉	통과 (0.27ms, 10.5MB)
테스트 6 〉	통과 (0.26ms, 10.3MB)
테스트 7 〉	통과 (0.26ms, 10.4MB)
테스트 8 〉	통과 (0.29ms, 10.2MB)
테스트 9 〉	통과 (0.26ms, 10.4MB)
테스트 10 〉	통과 (0.26ms, 10.4MB)
테스트 11 〉	통과 (0.26ms, 10.5MB)
테스트 12 〉	통과 (0.26ms, 10.5MB)
테스트 13 〉	통과 (0.26ms, 10.5MB)
테스트 14 〉	통과 (0.27ms, 10.4MB)
테스트 15 〉	통과 (0.26ms, 10.4MB)
테스트 16 〉	통과 (0.28ms, 10.4MB)
테스트 17 〉	통과 (0.31ms, 10.4MB)
테스트 18 〉	통과 (0.41ms, 10.4MB)
테스트 19 〉	통과 (0.47ms, 10.5MB)
테스트 20 〉	통과 (0.31ms, 10.4MB)
테스트 21 〉	통과 (0.37ms, 10.4MB)
테스트 22 〉	통과 (0.28ms, 10.4MB)
테스트 23 〉	통과 (0.46ms, 10.4MB)
테스트 24 〉	통과 (0.48ms, 10.4MB)
테스트 25 〉	통과 (0.47ms, 10.5MB)
